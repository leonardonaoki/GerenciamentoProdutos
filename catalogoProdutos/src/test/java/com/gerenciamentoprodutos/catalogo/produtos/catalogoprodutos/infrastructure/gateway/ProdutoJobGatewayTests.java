...
import com.gerenciamentoprodutos.catalogo.produtos.catalogoprodutos.gateway.IProdutoJobGateway;
import com.gerenciamentoprodutos.catalogo.produtos.catalogoprodutos.gateway.ProdutoJobGateway;
...
class ProdutoJobGatewayTests {
    ...
    @Test
    void deveExibirUmErroEmCasoDeTimeOut() throws JobInstanceAlreadyCompleteException, JobExecutionAlreadyRunningException, JobParametersInvalidException, JobRestartException, SystemBaseHandleException {
        jobExecution.setStatus(BatchStatus.STARTED);
        Mockito.when(joblauncher.run(any(), any())).thenReturn(jobExecution);
        assertThrows(SystemBaseHandleException.class, () -> produtoJobGateway.execute(csvFile));
    }
    @Test
    void deveExibirUmResponseComErroNoCasoDeStatusInesperado() throws JobInstanceAlreadyCompleteException, JobExecutionAlreadyRunningException, JobParametersInvalidException, JobRestartException, SystemBaseHandleException {
    ...
    @Test
    void deveRetornarUmErroSeArquivoNaoExistir() throws JobInstanceAlreadyCompleteException, JobExecutionAlreadyRunningException, JobParametersInvalidException, JobRestartException, SystemBaseHandleException {
        jobExecution.setStatus(BatchStatus.UNKNOWN);
